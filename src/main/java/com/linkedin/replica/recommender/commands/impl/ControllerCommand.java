...
public class ControllerCommand extends Command {
    ...
    @Override
    public LinkedHashMap<String, Object> execute() throws SecurityException, IllegalArgumentException, NoSuchMethodException, IllegalAccessException {
    ...
    public static void addCommand(Object val) throws IOException {
        ...
        config.setCommandsConfig(commandConfigPropKey, fileName);
        config.setCommandsConfig(commandConfigPropKey + ".handler", handlerClassName);
    }
    ...
    public static void deleteCommand(Object val) throws IOException {
        ...
        config.setCommandsConfig(commandConfigPropKey, null);
        config.setCommandsConfig(commandConfigPropKey + ".handler", null);
    }
    ...
    private static void writeFile(String fileName, String packageName, byte[] bytes) throws IOException {
        ...
        String folderPath = config.getAppConfig("app.classes.path");
