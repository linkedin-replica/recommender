...
import com.linkedin.replica.recommender.controller.handlers.RequestProcessingHandler;
...
public class RequestProcessingHandlerTest {
    ...
    public static void setup() throws IOException {
        ...
        String[] a = {"src/main/resources/config/app.config", "src/main/resources/config/arango.test.config",
    ...
    public void testAddingCommand() throws IOException, ClassNotFoundException, InstantiationException, IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        ...
        String folderPath = Configuration.getInstance().getAppConfig("app.classes.path");
        ...
        assertEquals(Configuration.getInstance().getCommandConfig("search.test"), "testCommand");
        assertEquals(Configuration.getInstance().getCommandConfig("search.test.handler"), "ArangoSearchHandler");
        // delete added file
    ...
    public void testDeletingCommand() throws IOException, ClassNotFoundException, InstantiationException, IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        ...
        // check that app.config file was updated
        assertNotEquals(Configuration.getInstance().getCommandConfig("search.test"), "testCommand");
        assertNotEquals(Configuration.getInstance().getCommandConfig("search.test.handler"), "ArangoSearchHandler");
    }
